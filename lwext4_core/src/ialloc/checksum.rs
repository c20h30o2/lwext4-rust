...
///
/// 对应 lwext4 的 `ext4_ialloc_bitmap_csum()`
///
/// # 参数
///
/// * `sb` - superblock 引用
...
pub fn bitmap_csum(sb: &Superblock, bitmap: &[u8]) -> u32 {
    ...
    // 然后计算位图的校验和
    let bitmap_size = ((inodes_per_group + 7) / 8) as usize;
...
/// 设置 inode 位图的校验和
///
/// 对应 lwext4 的 `ext4_ialloc_set_bitmap_csum()`
///
/// # 参数
///
/// * `sb` - superblock 引用
...
/// 验证 inode 位图的校验和
///
/// 对应 lwext4 的 `ext4_ialloc_verify_bitmap_csum()`
///
/// # 参数
///
/// * `sb` - superblock 引用
